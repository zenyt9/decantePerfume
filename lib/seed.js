...
const TIERS = {
  designer: { 5: 14000, 10: 25000, 20: 45000, 50: 99000,  100: 179000 },
  premium:  { 5: 19000, 10: 34000, 20: 62000, 50: 135000, 100: 249000 },
  niche:    { 5: 32000, 10: 58000, 20: 105000, 50: 239000, 100: 439000 },
};
...
const SEED_PRODUCTS = [
  ...
  /* ---- Эмэгтэй топ 10 (нэмэлт) ---- */
  { name: "Black Opium", brand: "Yves Saint Laurent", gender: "women", tier: "premium", accent: "#2a2233", year: 2014, popular: true,
    notes: { top: ["Лийр", "Ягаан чинжүү", "Улбар шар цэцэг"], heart: ["Кофе", "Жасмин", "Гашуун бүйлс"], base: ["Ваниль", "Пачули", "Хуш мод"] },
    description: "Кофе-ванилийн донтом гурманд. Шөнийн үдэшлэгт зориулсан зоримог, сэтгэл татам эмэгтэйлэг үнэр." },
  { name: "Idôle", brand: "Lancôme", gender: "women", tier: "premium", accent: "#d98ca0", year: 2019, popular: true,
    notes: { top: ["Бергамот", "Ягаан чинжүү"], heart: ["Сарнай", "Жасмин"], base: ["Ак миск", "Ваниль", "Пачули"] },
    description: "Цэвэрхэн, орчин үеийн сарнай. Хөнгөн миск-сарнайн хослол өдөр тутмын гоёмсог сонголт." },
  { name: "No. 5", brand: "Chanel", gender: "women", tier: "premium", accent: "#cdb98a", year: 1921, popular: true,
    notes: { top: ["Альдегид", "Нероли", "Илан-иланг"], heart: ["Сарнай", "Жасмин", "Ирис"], base: ["Сандал мод", "Ваниль", "Ак миск"] },
    description: "Түүхэн домогт сонгодог. Цэцэг-альдегидийн эрхэмсэг хослол мөнхийн эмэгтэйлэг байдлын бэлгэдэл." },
  { name: "Chance Eau Tendre", brand: "Chanel", gender: "women", tier: "premium", accent: "#e6a8c0", year: 2010, popular: false,
    notes: { top: ["Грейпфрут", "Квинс"], heart: ["Жасмин", "Гиацинт"], base: ["Ирис", "Ак миск", "Хув"] },
    description: "Зөөлөн, цэнгэг цэцэгт үнэр. Грейпфрут-жасмины хөнгөн, романтик мэдрэмж залуу төрхөд тохирно." },
  { name: "J'adore", brand: "Dior", gender: "women", tier: "premium", accent: "#d4af5f", year: 1999, popular: true,
    notes: { top: ["Илан-иланг", "Бергамот"], heart: ["Сарнай", "Жасмин", "Магнолия"], base: ["Миск", "Ваниль", "Кедр"] },
    description: "Тансаг цэцгэн баглаа. Илан-иланг, сарнай, жасмины эмэгтэйлэг, эрхэмсэг сонгодог." },
  { name: "Miss Dior", brand: "Dior", gender: "women", tier: "premium", accent: "#d98a9a", year: 2017, popular: false,
    notes: { top: ["Улаан жүрж", "Бергамот"], heart: ["Грассын сарнай", "Пион"], base: ["Сандал мод", "Ак миск"] },
    description: "Романтик сарнайн баглаа. Цитрус-сарнайн шинэлэг, эмэгтэйлэг үнэр хайр дурлалын бэлэг тэмдэг." },
  { name: "Angel", brand: "Mugler", gender: "women", tier: "niche", accent: "#2f5aa0", year: 1992, popular: false,
    notes: { top: ["Бергамот", "Нэрс жимс"], heart: ["Зөгийн бал", "Улаан жимс", "Гүйлс"], base: ["Пачули", "Ваниль", "Карамель"] },
    description: "Анхны гурманд домог. Пачули-карамелийн хүчтэй, амтат хослол ялгаралтай, мартагдашгүй." },
  { name: "Flowerbomb", brand: "Viktor & Rolf", gender: "women", tier: "niche", accent: "#e08fb0", year: 2005, popular: true,
    notes: { top: ["Цай", "Бергамот"], heart: ["Жасмин", "Орхидей", "Сарнай"], base: ["Пачули", "Ваниль", "Ак миск"] },
    description: "Дэлбэрсэн цэцгэн бөмбөг. Жасмин-пачулийн баялаг, чихэрлэг цэцэгт үнэр анхаарал татна." },
  { name: "Sì", brand: "Giorgio Armani", gender: "women", tier: "premium", accent: "#5a2a3a", year: 2013, popular: false,
    notes: { top: ["Хар үхрийн нүд", "Мандарин"], heart: ["Сарнай", "Фрезия"], base: ["Ваниль", "Пачули", "Амбер мод"] },
    description: "Орчин үеийн шипр. Хар үхрийн нүд-сарнайн гүн, дэгжин эмэгтэйлэг хүч чадлыг илэрхийлнэ." },
  { name: "Bloom", brand: "Gucci", gender: "women", tier: "premium", accent: "#d98cb0", year: 2017, popular: false,
    notes: { top: ["Рангун цэцэг"], heart: ["Туберза", "Жасмин самбак"], base: ["Ирисын үндэс", "Ак миск"] },
    description: "Цэцэрлэгийн цэлмэг цэцэг. Туберза-жасмины баялаг, эмэгтэйлэг цэцэгт үнэр романтик төрхийг нэмнэ." },
];

/* Анхны хэрэглэгчийн сэтгэгдэл (админ засаж/устгаж болно) */
const SEED_REVIEWS = [
...
function ensureSeeded() {
  ...
  // Сэтгэгдлийг нэг удаа суулгах (аль хэдийн seed хийгдсэн live сан дээр ч
  // ажиллана). reviewsSeeded тэмдэглэгдсэн бол дахин нэмэхгүй — админ бүх
  // сэтгэгдлээ устгасан ч redeploy дээр буцаж нэмэгдэхгүй.
  if (!db.load().meta.reviewsSeeded) {
    SEED_REVIEWS.forEach((r) => {
      db.insert("reviews", { id: genId("review"), text: r.text, author: r.author, createdAt: Date.now() });
    });
    db.load().meta.reviewsSeeded = true;
    db.save();
  }
  ...
  SEED_PRODUCTS.forEach((p) => {
    ...
    db.insert("products", {
      ...
      prices: { 5: tier[5], 10: tier[10], 20: tier[20], 50: tier[50], 100: tier[100] },
      active: true,
      createdAt: Date.now(),
    });
  });
